...
#define	MODULO_EN_RED		1
#define	CONECTADO		2
#define	ESPERA_INICIO		3
#define	ESPERA_MENSAJE_MOVIMIENTO		4
#define	ESPERA_FIN		5
#define	ESPERAR_MENSAJE_VELOCIDAD_1		6
#define	ESPERAR_MENSAJE_VELOCIDAD_2		7
#define	SIN_MOVIMIENTO		8
#define	ADELANTE		9
#define	ATRAS		10
#define	DERECHA		11
#define	IZQUEIRDA		12
